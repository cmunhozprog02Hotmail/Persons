...
namespace Persons.Controllers
{
    public class PersonsDatasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Age,Nome,Sex")] PersonsData personsData)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Age,Nome,Sex")] PersonsData personsData)
        {
